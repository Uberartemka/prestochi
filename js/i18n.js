...
window.PRESTOCHI_I18N = (function () {
  ...
  const D = {
    ...
    'results.m1.label': { ru: 'клиентской базы<br />уже попробовали HHB', zh: '客户群<br />已试用 HHB' },
    'results.m2.label': { ru: 'компаний используют HHB<br />на&nbsp;100% по&nbsp;корпусным', zh: '家企业在带座轴承方向<br />100% 使用 HHB' },
    ...
    'growth.lead':    { ru: 'Сейчас в&nbsp;нашей базе около <strong>600 клиентов</strong>. HHB уже попробовали <strong>100 компаний</strong>, из&nbsp;них <strong>50</strong> используют HHB на&nbsp;100% по&nbsp;корпусным подшипникам — это <strong>8,3%</strong> от&nbsp;текущей базы. Ёмкость только Черноземья по&nbsp;корпусным — около <strong>1000 компаний</strong>; Юг добавит сопоставимый потенциал.',
    ...
    'growth.step1.eyebrow': { ru: 'Точка отсчёта · 2025', zh: '起点 · 2025' },
    ...
    'growth.step3.text':    { ru: 'Это расчёт только по&nbsp;корпусным подшипникам и&nbsp;только по&nbsp;Черноземью. Южные регионы могут дать сопоставимую ёмкость для дальнейшего роста проекта.',
                              zh: '该测算仅针对带座轴承，且仅限黑土区。南部地区可为项目进一步增长带来同等容量。' },
    ...
    // ─── СЛАЙД 5 — КЛИЕНТЫ ───
    'clients.eyebrow': { ru: '05 · Спрос на&nbsp;столе', zh: '05 · 现有客户群' },
    ...
    'clients.lead':    { ru: 'Ключевые компании, с&nbsp;которыми мы&nbsp;ведём работу по&nbsp;корпусным подшипникам HHB.',
                         zh: '我们正在围绕 HHB 带座轴承开展工作的重点企业。' },
    'clients.footer':  { ru: 'Фокус — на&nbsp;крупных агрохолдингах и&nbsp;производственных предприятиях, где корпусные подшипники используются регулярно.',
                         zh: '重点是大型农业控股和生产型企业，带座轴承在这些企业中被持续使用。' },

    // ─── СЛАЙД 6 — МЕТОД ───
    'method.eyebrow': { ru: '06 · Как мы&nbsp;продаём', zh: '06 · 我们的销售方法' },
    ...
    // ─── СЛАЙД 7 — ТЕХНИЧЕСКИЙ ОТДЕЛ ───
    'tech.eyebrow': { ru: '07 · Экспертиза', zh: '07 · 技术专长' },
    ...
    // ─── СЛАЙД 8 — ЦИФРОВАЯ СТРАТЕГИЯ ───
    'digital.eyebrow': { ru: '08 · Цифровая стратегия 2026', zh: '08 · 数字战略 2026' },
    ...
    'digital.c5.p': { ru: 'LLM на&nbsp;сайте подбирает подшипник по&nbsp;параметрам узла и&nbsp;отдаёт предпочтение продукции HHB. Снижает порог входа для&nbsp;новых клиентов.',
                      zh: '网站大型语言模型根据机组参数推荐轴承，并优先推荐 HHB 产品。降低新客户的入门门槛。' },
    ...
    // ─── СЛАЙД 9 — РАЗВИЛКА ───
    'fork.eyebrow': { ru: '09 · Развилка', zh: '09 · 关键抉择' },
    ...
    'fork.pos.i1': { ru: 'Понятная ответственность за&nbsp;развитие при закреплённом партнёрстве', zh: '在稳定合作模式下明确发展责任' },
    ...
    'fork.pos.i5': { ru: 'Понятное ценообразование для потребителей на&nbsp;российском рынке', zh: '为俄罗斯市场终端客户建立清晰定价' },

    'fork.neg.title': { ru: 'Без закреплённой модели', zh: '没有明确合作模式时' },
    'fork.neg.i1': { ru: 'Продвижение бренда идёт менее системно и&nbsp;медленнее',
                     zh: '品牌推广会不够系统，速度更慢' },
    'fork.neg.i2': { ru: 'Сложнее прогнозировать склад и&nbsp;минимальные партии под реальный спрос',
                     zh: '更难根据真实需求预测库存与最低起订量' },
    ...
    'final.title':   { ru: 'Предлагаем закрепить<br /><em>эксклюзивное дистрибьюторство HHB</em>',
                       zh: '建议确认<br /><em>HHB 独家经销权</em>' },
    ...
    'final.p2': { ru: '<strong>Присвоить</strong><br />сертификат эксклюзивного дистрибьютора', zh: '<strong>颁发</strong><br />独家经销商证书' },
