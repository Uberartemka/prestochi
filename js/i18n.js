...
window.PRESTOCHI_I18N = (function () {
  ...
  const D = {
    ...
    'map.counter.today': { ru: 'сегодня', zh: '现有' },
    'map.counter.goal':  { ru: 'цель',    zh: '目标' },

    'map.legend.current.title': { ru: 'Сегодня',  zh: '现有' },
    ...
    'step2.eyebrow': { ru: '02 · Старт',          zh: '02 · 起点' },
    'step2.title':   { ru: 'Сегодня: Юг России',  zh: '起点：俄罗斯南部' },
    'step2.text':    { ru: 'Опорная база — <strong>Воронежская, Белгородская области и&nbsp;Краснодарский край</strong>. Плотный южный рынок с&nbsp;развитой логистикой.',
                       zh: '基地区域：<strong>沃罗涅日州、别尔哥罗德州和克拉斯诺达尔边疆区</strong>。市场密集、物流发达的南部地区。' },
    ...
    // ─── СЛАЙД 3.5 — КЛИЕНТЫ ───
    'clients.eyebrow': { ru: 'Спрос на&nbsp;столе', zh: '现有客户群' },
    ...
    // ─── СЛАЙД 4 — МЕТОД ───
    'method.eyebrow': { ru: '04 · Как мы&nbsp;продаём', zh: '04 · 我们的销售方法' },
    ...
    'tech.eyebrow': { ru: '05 · Экспертиза', zh: '05 · 技术专长' },
    ...
    'digital.eyebrow': { ru: '06 · Цифровая стратегия 2026', zh: '06 · 数字战略 2026' },
    ...
    // ─── СЛАЙД 7 — РАЗВИЛКА ───
    'fork.eyebrow': { ru: '07 · Развилка', zh: '07 · 关键抉择' },
