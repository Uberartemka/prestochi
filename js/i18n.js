...
window.PRESTOCHI_I18N = (function () {
  ...
  const D = {
    ...
    'growth.title':   { ru: 'От&nbsp;0 до&nbsp;<em>доминирования</em><br />за&nbsp;5&nbsp;лет',
                        zh: '5 年内从 0 达到<em>市场主导</em>' },
    'growth.lead':    { ru: 'Начали с&nbsp;первых поставок в&nbsp;2024&nbsp;— сегодня HHB уже у&nbsp;<strong>половины</strong> клиентов. К&nbsp;2028&nbsp;г. выйдем на&nbsp;<strong>85%</strong>: в&nbsp;России останется главный подшипниковый бренд — HHB.',
                        zh: '2024年从首批供货开始，如今 HHB 占据<strong>一半</strong>客户。于 2028年达到 <strong>85%</strong>：HHB 将成为俄罗斯市场的主导轴承品牌。' },
    'growth.s1.label':{ ru: 'сегодня<br />2026&nbsp;г.',          zh: '现状<br />2026年' },
    'growth.s2.label':{ ru: 'цель<br />2028&nbsp;г.',             zh: '目标<br />2028年' },
    'growth.s3.label':{ ru: 'рост объёма<br />поставок 2024→2028', zh: '供货量增长<br />2024–2028' },
    'growth.step1.eyebrow': { ru: 'Точка отсчёта · 2024', zh: '起点 · 2024' },
    'growth.step1.title':   { ru: 'Первые поставки HHB',     zh: 'HHB 首批供货' },
    'growth.step1.text':    { ru: 'Привезли первые образцы, запустили тесты у&nbsp;первых клиентов. HHB — всего&nbsp;<strong>15%</strong> от&nbsp;наших объёмов.',
                              zh: '首批样品交付，首批客户开始测试。HHB 仅占我们业务量的 <strong>15%</strong>。' },
    'growth.step2.eyebrow': { ru: 'Сегодня · 2026', zh: '现状 · 2026' },
    'growth.step2.title':   { ru: 'Половина пути пройдена',  zh: '已走过一半路程' },
    'growth.step2.text':    { ru: 'Сегодня уже&nbsp;<strong>половина</strong> нашей клиентской базы работает на&nbsp;HHB. Объёмы выросли в&nbsp;<strong>×5</strong> за&nbsp;два года.',
                              zh: '如今 <strong>一半</strong> 客户使用 HHB，两年内供货量增长 <strong>×5</strong>。' },
    'growth.step3.eyebrow': { ru: 'Цель · 2028', zh: '目标 · 2028' },
    'growth.step3.title':   { ru: 'Доминирование на&nbsp;рынке', zh: '市场主导地位' },
    'growth.step3.text':    { ru: 'К&nbsp;2028&nbsp;году — <strong>85%</strong> наших поставок идёт через HHB. Объём рынка вырастает в&nbsp;<strong>×10</strong> от&nbsp;старта&nbsp;2024.',
                              zh: '于 2028 年 — <strong>85%</strong> 供货通过 HHB。业务量从 2024 年增长 <strong>×10</strong>。' },
    'growth.axis':    { ru: 'Доля клиентов, переведённых на&nbsp;HHB, %', zh: '转换为 HHB 的客户占比 %' },
